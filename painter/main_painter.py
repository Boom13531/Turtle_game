...
import turtle
# My functions
from painter.functions.keys import move_up, move_down, move_left, move_right
from painter.functions.keys import color_edit, pen_up_or_down, pen_fill, clear_screen
from painter.functions.keys import screen, pen, painter, move
